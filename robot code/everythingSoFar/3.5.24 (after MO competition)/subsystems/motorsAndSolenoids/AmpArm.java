...
public class AmpArm extends SubsystemBase {
  ...
  //Make amp arm
  private static final int ampArmID = 10;

  //make a motor
  CANSparkMax m_ampArm;
  ...
  public AmpArm() {
    //initialize amp arm
    m_ampArm = new CANSparkMax(ampArmID, MotorType.kBrushless);
  ...
  public void MoveArm(double x) {
    m_ampArm.set(x);
    //System.out.println("Encoder position: " + m_ampArm.getEncoder().getPosition());
  }
