...
public class Drivetrain extends SubsystemBase {
  ...
  // }
    ...
    //crawl function
    public void crawl(double plusMinus) {
      m_frontLeft.set(0.1 * plusMinus);
      m_frontRight.set(0.1 * plusMinus);
    }
    
    public void crawlSpin(int left, int right){
      m_frontLeft.set(0.1 * left);
      m_frontRight.set(0.1 * right);
    }
